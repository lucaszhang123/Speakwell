...
const EMPHATIC_REPEATS = new Set(['no', 'yes', 'very', 'really', 'so', 'never']);
const TRAILING_CONNECTORS = new Set(['a', 'an', 'and', 'as', 'at', 'because', 'but', 'for', 'from', 'if', 'in', 'of', 'on', 'or', 'so', 'than', 'that', 'the', 'then', 'to', 'when', 'which', 'with']);
